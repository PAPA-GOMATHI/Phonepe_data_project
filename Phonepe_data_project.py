...
st.set_page_config(page_title="PHONEPE PROJECT" ,
                   page_icon = icon,
                   layout= "wide")

st.header(":violet[PHONEPE]:rainbow[ DATA VISUALIZATION AND EXPLORATION]")
...
with tab1:
    ...
    with col1:
        ...
        st.subheader(":orange[INDIA'S BEST TRANSACTION APP]")
        st.markdown(":rainbow[PhonePe  is an Indian digital payments and financial technology company]")
        st.write(":rainbow[****FEATURES****]")
        st.write("   :red[👉] Credit & Debit card linking")
        st.write("   :red[👉] Bank Balance check")
        st.write("   :red[👉] Money Storage")
        st.write("   :red[👉] PIN Authorization")
        st.download_button("DOWNLOAD THE APP NOW", "https://www.phonepe.com/app-download/")
        
    with col2:
        st.video("C:\\Users\\ELCOT\\Downloads\\ZEN CLASS NOTES\\CAPSTONE PROJECTS\\Phonepe\\Phone Pe Ad.mp4")
        
    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\ELCOT\\Downloads\\ZEN CLASS NOTES\\CAPSTONE PROJECTS\\Phonepe\\PhonePe Motion Graphics.mp4")
    
    with col4:
        st.write(" :red[👉] Easy Transactions")
        st.write(" :red[👉]  One App For All Your Payments")
        st.write(" :red[👉]  Your Bank Account Is All You Need")
        st.write(" :red[👉]  Multiple Payment Modes")
        st.write(" :red[👉]  PhonePe Merchants")
        st.write(" :red[👉]  Multiple Ways To Pay")
        st.write(" :red[👉]  1.Direct Transfer & More")
        st.write(" :red[👉]  2.QR Code")
        st.write(" :red[👉]  Earn Great Rewards")
    ...
    with col5:
        ...
        st.markdown(" ")
        st.markdown(" ")
        st.write(" :red[👉] No Wallet Top-Up Required")
        st.write(" :red[👉] Pay Directly From Any Bank To Any Bank A/C")
        st.write(" :red[👉] Instantly & Free")
        
    with col6:
        image = Image.open('app_use.jpeg')

        st.image(image, caption='Phonepe Users')
        st.balloons()
